"""
Django settings for testcheck_dev_82064 project.
...
ROOT_URLCONF = 'testcheck_dev_82064.urls'
...
WSGI_APPLICATION = 'testcheck_dev_82064.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testcheck_dev_82064 API",
    "DESCRIPTION": "API documentation for testcheck_dev_82064 App",
    "VERSION": "v1",
}
